...
class RunningTest {
    ...
    void applicationShouldRespondOnPort8080() {
        ...
        // Effettua una chiamata GET a /ping per verificare che l'applicazione sia in piedi
        ResponseEntity<String> response = restTemplate.getForEntity("http://localhost:8080/octquiz/ping", String.class);
